export function NodejsIcon() {
  return (
    ...
    >
      <svg viewBox="0 0 442.37 270.929" xmlns="http://www.w3.org/2000/svg" className="w-8 h-auto">
        <defs>
          ...
          <linearGradient id="nodejs-b" x1="-.348" x2="1.251" gradientTransform="rotate(116.114 53.1 202.97) scale(86.48)" gradientUnits="userSpaceOnUse">
          ...
          <linearGradient id="nodejs-d" x1="-.456" x2=".582" gradientTransform="rotate(-36.46 550.846 -214.337) scale(132.798)" gradientUnits="userSpaceOnUse">
          ...
          <linearGradient id="nodejs-f" x1=".043" x2=".984" gradientTransform="translate(192.862 279.652) scale(97.417)" gradientUnits="userSpaceOnUse">
        ...
        <path fill="#689f63" fillRule="evenodd" d="M394.538 105.2c.3-.177.676-.177.98 0l8.13 4.69c.304.176.49.5.49.85v9.39c0 .35-.186.674-.49.85l-8.13 4.69c-.304.177-.68.177-.98 0l-8.125-4.69c-.31-.176-.5-.5-.5-.85v-9.39c0-.35.18-.674.49-.85z" />
        <g clipPath="url(#nodejs-a)" transform="translate(-78.306 -164.016)">
          <path fill="url(#nodejs-b)" d="M331.363 246.793l-118.715-58.19-60.87 124.174L270.49 370.97z" />
        </g>
        <g clipPath="url(#nodejs-c)" transform="translate(-78.306 -164.016)">
          <path fill="url(#nodejs-d)" d="M144.07 264.004l83.825 113.453 110.86-81.906-83.83-113.45z" />
        </g>
        <g clipPath="url(#nodejs-e)" transform="translate(-78.306 -164.016)">
          <path fill="url(#nodejs-f)" d="M197.02 225.934v107.43h91.683v-107.43z" />
        </g>
      </svg>
    </div>
  );
